...
agents: ["Lint Agent", "Test Agent"]
target: vscode
handoffs:
  - label: Final Lint Validation
    agent: Lint Agent
    prompt: "Let's ensure markdown quality is validated."
    send: false
---
...
Refer to documentation files for related features and detailed information.
